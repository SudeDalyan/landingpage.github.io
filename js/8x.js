...
//=============================
  // Save user selection via cookie
  //=============================

	
	
if($.cookie("css")) {
	$("#switch_style").attr("href",$.cookie("css"));
}
$(document).ready(function() { 
	$(".box").click(function() { 
	    var id = $(this).attr("id");
    	$("#switch_style").attr("href", "css/themes/" + id + ".css");
		var style = $("#switch_style").attr("href", "css/themes/" + id + ".css");
		$.cookie("css",$('#switch_style').attr('href'), {expires: 7, path: '/'});
		return false;
	}); });
